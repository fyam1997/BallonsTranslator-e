...
a = Analysis([
    ...
    datas=[
        ...
        ('ui', './ui'),
        ('utils', './utils'),
        ('.venv/lib/python3.9/site-packages/spacy_pkuseg', './spacy_pkuseg'),
        ('.venv/lib/python3.9/site-packages/torchvision', './torchvision'),
        ('.venv/lib/python3.9/site-packages/translators', './translators'),
        ('.venv/lib/python3.9/site-packages/cryptography', './cryptography'),
        ],
    hiddenimports=[
        'PyQt6',
        'numpy',
